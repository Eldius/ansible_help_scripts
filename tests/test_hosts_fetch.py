...
from hosts_fetch import main

def test_hosts_fetch_main(capsys):
    # Mock get_lan_ip and address2net
    with patch("hosts_fetch.get_lan_ip", return_value="192.168.0.5"), \
         patch("hosts_fetch.address2net", return_value="192.168.0.0/24"), \
         patch("hosts_fetch.get_hosts", new_callable=AsyncMock, return_value=[("192.168.0.10", "ssh")]):
